...
export default function Instructor() {
  ...
  return (
    <section id="instructor" className="py-14 md:py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-txt-secondary mb-6 max-w-md mx-auto leading-relaxed whitespace-pre-line">
            {instructor.bio}
          </p>
          ...
          >
            <svg className="w-6 h-6 mx-auto text-primary/40 mb-3" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
            </svg>
            <p className="text-lg text-primary font-medium italic whitespace-pre-line">
